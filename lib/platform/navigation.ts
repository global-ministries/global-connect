...
const PLATFORM_NAVIGATION_DEFINITIONS = [
  ...
  { id: 'talleres_admin', capability: 'talleres_crecimiento.admin.manage', label: 'Administración Talleres', availableHref: '/talleres/direccion/talleres', experience: 'talleres_crecimiento', fallbackScope: { experience: 'talleres_crecimiento', type: 'taller', id: 'global' } },
