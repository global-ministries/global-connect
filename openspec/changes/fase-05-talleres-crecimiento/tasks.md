...
- [x] **PR10** `size:exception` certificados + QR + verification page + periodo_general, `type:certificates`, `F(talleres/{certificates,periodo-general})`, `DB+HTTP`, revert=migration-unapplied + kill-switch, ~500
