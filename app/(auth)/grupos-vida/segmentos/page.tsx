            ...
            {segmentos && segmentos.length > 0 ? (
              segmentos.map(segmento => (
                <div key={segmento.id}>
                  ...
                  <Link href={`/grupos-vida/segmentos/${segmento.id}`} className="sm:hidden flex items-center gap-3 p-3 bg-card rounded-lg border border-border hover:bg-accent/50 transition-colors">
                  ...
                  <Link href={`/grupos-vida/segmentos/${segmento.id}`} className="hidden sm:block">
