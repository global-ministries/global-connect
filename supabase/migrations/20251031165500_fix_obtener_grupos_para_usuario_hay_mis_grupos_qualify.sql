-- Fix: calificar soy_miembro en CTE stats para evitar ambigüedad y coalesce a false
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean) IS 'Lista grupos visibles; soy_miembro calificado en stats, hay_mis_grupos global, estado_temporal y supervisado_por_mi.';
