-- Actualiza obtener_grupos_para_usuario para incluir estado_temporal (actual, pasado, futuro)
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean) IS 'Lista grupos visibles para usuario con filtros, incluye estado_temporal (actual/pasado/futuro) y soporta papelera (eliminado).';
