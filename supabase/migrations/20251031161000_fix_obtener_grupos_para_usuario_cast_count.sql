-- Fix tipos: castear count(*) a integer para miembros_count y mantener total_count como bigint
-- Basado en 20251031160500 evitando ambigüedades y conservando estado_temporal
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean) IS 'Lista grupos visibles; tipos corregidos (miembros_count int, total_count bigint), estado_temporal y supervisado_por_mi.';
