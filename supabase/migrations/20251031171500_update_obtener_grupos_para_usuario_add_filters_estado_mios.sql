-- Extiende obtener_grupos_para_usuario con filtros p_estado_temporal y p_solo_mios
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean, text, boolean) IS 'Lista grupos visibles con filtros por estado_temporal y solo-mios; incluye soy_miembro, soy_lider y hay_mis_grupos.';
