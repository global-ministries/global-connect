-- Fix: ORDER BY/LIMIT en actividad reciente para evitar 42803 y ordenar correctamente
...
BEGIN
  ...
  -- Asistencia semanal (incluye todos los grupos activos)
  BEGIN
  ...
  -- Actividad reciente: ordenar/limitar en subselect y ordenar dentro del agregado
  v_actividad := (
    SELECT COALESCE(
