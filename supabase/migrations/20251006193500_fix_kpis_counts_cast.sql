-- Fix tipos COUNT(): COUNT(*) devuelve bigint y la función declaraba integer -> causaba "structure of query does not match function result type"
-- Ajustamos casteos explícitos a integer.
