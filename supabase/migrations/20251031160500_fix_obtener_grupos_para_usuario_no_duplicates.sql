-- Fix definitivo: evitar ambigüedades calificando columnas y sin duplicar nombres
-- Basado en 20251008120500_fix_obtener_grupos_para_usuario_supervisado + estado_temporal
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean) IS 'Lista grupos visibles; columnas explícitas sin duplicados, incluye estado_temporal y supervisado_por_mi.';
