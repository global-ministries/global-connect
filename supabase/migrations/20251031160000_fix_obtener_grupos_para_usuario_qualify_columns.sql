-- Fix: calificar columnas para evitar ambigüedad con parámetros de salida (RETURNS TABLE)
...
COMMENT ON FUNCTION public.obtener_grupos_para_usuario(uuid, uuid, uuid, boolean, uuid, uuid, int, int, boolean) IS 'Lista grupos visibles para usuario; incluye estado_temporal y flag supervisado_por_mi. Columnas calificadas para evitar ambigüedad.';
